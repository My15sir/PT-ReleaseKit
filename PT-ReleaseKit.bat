...
set "SCRIPT_DIR=%~dp0"
set "APP_EXE=%SCRIPT_DIR%PT-ReleaseKit.exe"
set "LEGACY_APP_EXE=%SCRIPT_DIR%PT-BDtool.exe"
...
echo [HINT] Or use the packaged standalone PT-ReleaseKit.exe instead.
pause
exit /b 1
